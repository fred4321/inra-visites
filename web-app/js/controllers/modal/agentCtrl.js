...
angular.module('Agent', ['ui.bootstrap', 'formINRA'])
        .controller('AgentCtrl', ['$scope', '$modalInstance', 'InstanceVM', 'InstanceBS', 'ReferentielService', 'items', 'AgentService','UserService','createDate',
            function ($scope, $modalInstance, InstanceVM, InstanceBS, ReferentielService, items, AgentService,UserService,createDate) {
                $scope.access = false;
                ...
                AgentService.get(items, function(result){
                ...
                ReferentielService.getAll(function (result) {
                    for (var i in result.data) {
                        $scope.natureVM.push(result.data[i].valeur);
                    }
        ...
        factory('InstanceAgent', ['$modal', function ($modal) {
                return function () {
                    this.params = {
